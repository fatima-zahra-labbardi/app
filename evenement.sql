...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 12 jan. 2024 à 14:36
...
INSERT INTO `events` (`id_event`, `titre`, `description`, `date`, `lieu`, `photo`, `id_admin`, `id_ctg`) VALUES
(2, 'php formation', 'formation sur php', '2024-01-22', 'ensak l\'amphi rouge', 0x39363430353231366563653065363234633236653963626132376136383138612e6a7067, NULL, 2);
...
INSERT INTO `participant` (`login`, `id_part`, `mail`, `nom`, `prenom`, `role`, `passe`) VALUES
('fati', 21007921, 'fatimazahra.labbardi@uit.ac.ma', 'labbardi', 'fatima zahra', 'etudiante', '1234'),
('mary', 21017921, 'maryam.labbardi@uit.ac.ma', 'labbardi', 'maryam', 'etudiante', '1234');
